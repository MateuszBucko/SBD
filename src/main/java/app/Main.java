...
public class Main {
	...
	// User user = new User("Jan", "Kowalski", "Lesna", "Warszawa", "mail",
	// "15-888", "992323232");
	// Shop shop = new Shop("Nazwa sklepu 111", "adres sklepu 111", "Miasto
	// sklepu 111", "15-888", "telefon sklepu",
	// "nip sklepu");
	// ReportedProduct reportedProduct_1 = new ReportedProduct("Klawiatura
	// MSI10", "X343", "MSI", new Date());
	// reportedProduct_1.setUser(user);
	// reportedProduct_1.setShop(shop);
	// List<ReportedProduct> reportedProducts = new
	// ArrayList<ReportedProduct>();
